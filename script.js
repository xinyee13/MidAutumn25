...
function playMusic() {
    bgMusic.play().then(() => {
        ...
        // ***** CRITICAL FIX: Explicitly set the background layer's transform property to none. *****
        // This forces the browser to discard any unintended scaling/zooming caused by the click event.
        document.querySelector('.background-image-layer').style.transform = 'none';
        // ******************************************************************************************
        
        // 延遲煙花啟動 100 毫秒，避免瀏覽器在點擊後發生抖動/縮放
        setTimeout(() => {
