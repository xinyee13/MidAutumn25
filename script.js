...
function playMusic() {
    bgMusic.play().then(() => {
        ...
        // ***** CRITICAL FIX: AGGRESSIVELY RESET ALL BACKGROUND ANIMATION PROPERTIES *****
        const backgroundLayer = document.querySelector('.background-image-layer');
        
        // 1. Force remove any unintended transform (scaling/zooming)
        backgroundLayer.style.transform = 'none';
        // 2. Clear any lingering transitions that cause the continuous "breathing" effect
